...
- **Поддержка многотомных архивов** (.part1.rar, .part2.rar, .7z.001, .7z.002)
...
- **Инициализация библиотеки** (Инструменты → Стереть базу) с очисткой книг, хранилищ и категорий
...
└── web/
    ├── index.html       # SPA интерфейс (3 вкладки, кастомные модальные окна)
